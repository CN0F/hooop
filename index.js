...
client.ayarlar = {
  ...
  "oauthSecret": "sUOXSzpkZ2O_ZRWBeiqjc6koOkMdM6jN",// Botun Secreti
	"callbackURL":  "/callback",// siteismi.glitch.me/callback şeklinde olucak
	"kayıt": "785247169870561290",// Kayıt kanalının id si
  "rapor": "785247169870561290",// Rapor kanalının id si
  "renk": "#D49818"// bunu neden ekledim bende bilmiyorum isterseniz değiştirin
};
client.login("NzgxNTI5MTQ4NDYzMzgyNTg4.X7-9vQ.FBh7yodORN2bYdLTWw_wxYjq0Pc")// Token
process.env = {}
process.env.TOKEN = "NzgxNTI5MTQ4NDYzMzgyNTg4.X7-9vQ.0iFPsvTF-vAuUa2QqLyNk9HxCyo";// Token


client.yetkililer = ["783771607675437096"]// Yetkililer
client.webyetkililer = ["783771607675437096"]// Yetkililer
client.sunucuyetkililer = ["783771607675437096"]// Yetkililer
client.yetkililer = ["783771607675437096"]// Yetkililer
client.webyetkililer = ["783771607675437096"]// Yetkililer
